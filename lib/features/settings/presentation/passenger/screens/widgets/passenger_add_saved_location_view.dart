...
class PassengerAddSavedLocationView extends StatefulWidget {
  const PassengerAddSavedLocationView({super.key});

  @override
  State<PassengerAddSavedLocationView> createState() =>
      _PassengerAddSavedLocationViewState();
}

class _PassengerAddSavedLocationViewState
    extends State<PassengerAddSavedLocationView> {
  final Completer<GoogleMapController> _mapController =
      Completer<GoogleMapController>();
  final TextEditingController _nameController = TextEditingController();

  static const CameraPosition _initialPosition = CameraPosition(
    target: LatLng(31.9535, 35.9112),
    zoom: 15.5,
  );
              ...
              GoogleMap(
                ...
                onCameraIdle: () async {
                  ...
                  if (cubit.userAddLocationplacemarks.isNotEmpty) {
                    ...
                    if (mounted) {
                      setState(() {
                        _discoveredAddress = addr.isNotEmpty
                            ? addr
                            : S.of(context).specifiedMapLocation;
                      });
                    }
                  }
                },
                          ...
                          onPressed: (state is SaveLocationLoading)
                              ...
                              : () {
                                  ...
                                  if (name.isEmpty) {
                                    showToast(
                                      text:
                                          S.of(context).pleaseEnterLocationName,
