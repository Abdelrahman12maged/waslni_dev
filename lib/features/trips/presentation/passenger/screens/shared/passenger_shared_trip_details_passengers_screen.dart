...
/// Used when passengers subscribe to available seats in a shared trip.
/// Supports Approach C (in-memory [Trip], [tripId], or legacy [tripDetails]).
class PassengerSharedTripDetailsPassengersScreenClean extends StatefulWidget {
  ...
  @override
  State<PassengerSharedTripDetailsPassengersScreenClean> createState() =>
      _PassengerSharedTripDetailsPassengersScreenCleanState();
}

class _PassengerSharedTripDetailsPassengersScreenCleanState
    extends State<PassengerSharedTripDetailsPassengersScreenClean> {
  int currentIndex = 0;
  ...
  /// Sum of all seats booked by passengers currently in the trip (reserved_seats)
  ...
  /// Available remaining seats for new joiners (available_seats)
  ...
  /// Number of joined passengers (joined_passengers_count)
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<PassengerTripsCubit, PassengerTripsState>(
          ...
          builder: (context, state) {
            ...
            // Seats of OTHER passengers currently in the car (excluding me)
            final otherPassengersSeats = isJoined
                ? (totalBookedSeats - myExistingSeats).clamp(0, totalSeats)
                : totalBookedSeats;

            // Total seats that will be occupied with this booking/addition
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TabBarView(
                          physics: const NeverScrollableScrollPhysics(),
                          children: [
                            // ── Tab 0: Trip Details & Seat Booking ───────────
                            SingleChildScrollView(
                              physics: const BouncingScrollPhysics(),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  // ── Joined Status Banner (if already joined)
                                  if (isJoined) ...[
                                    Container(
                                  ...
                                  // ── Seats & Proportional Price Breakdown Card
                                  Container(
                                    padding: const EdgeInsets.all(16),
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        // Proportional Fare Breakdown Box
                                        Container(
                                  ...
                                  // ── Seat Selection / Increase Seats Card ─
                                  Container(
                                    padding: const EdgeInsets.all(16),
                                    decoration: BoxDecoration(
                                      color: Colors.white,
