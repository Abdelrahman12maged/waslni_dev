...
class DriverSignupInfoView extends StatefulWidget {
  final DriverSignupInitialData initialData;

  const DriverSignupInfoView({super.key, required this.initialData});

  @override
  State<DriverSignupInfoView> createState() => _DriverSignupInfoViewState();
}

class _DriverSignupInfoViewState extends State<DriverSignupInfoView> {
            ...
            child: Column(
              ...
              children: [
                ...
                SearchableDropdownField(
                  ...
                  validator: (v) {
                    if (v == null || v.isEmpty) {
                      return S.of(context).carTypeCantBeEmpty;
                    }
                    return null;
                  },
                ...
                SearchableDropdownField(
                  ...
                  validator: (v) {
                    if (v == null || v.isEmpty) {
                      return S.of(context).carModelCantBeEmpty;
                    }
                    return null;
                  },
      ...
      builder: (context, _) => Column(
        ...
        children: [
          ...
          _CameraOnlyImageBox(
            ...
            onTap: () =>
                cubit.getDriverInfoImages(0, source: ImageSource.camera),
          ),
          const SizedBox(height: 20),
          ...
          _CameraOnlyImageBox(
            ...
            hint: S.of(context).attachPhoto,
            onTap: () =>
                cubit.getDriverInfoImages(1, source: ImageSource.camera),
          ),
          const SizedBox(height: 20),
          ...
          _CameraOnlyImageBox(
            ...
            hint: S.of(context).attachPhoto,
            onTap: () =>
                cubit.getDriverInfoImages(2, source: ImageSource.camera),
          ),
        ],
      ),
    );
  ...
  Widget _buildKycDocumentsSection(BuildContext context, AuthCubit cubit) {
    return BlocBuilder<AuthCubit, AuthState>(
      buildWhen: (prev, cur) =>
          cur is DriverDocumentPickedSuccess || cur is DriverDocumentRemoved,
      builder: (context, _) => Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Row(
