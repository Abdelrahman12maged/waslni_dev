...
class DriverPrivateSuspendedView extends StatefulWidget {
  final Trip trip;

  const DriverPrivateSuspendedView({
    super.key,
    required this.trip,
  });

  @override
  State<DriverPrivateSuspendedView> createState() =>
      _DriverPrivateSuspendedViewState();
}

class _DriverPrivateSuspendedViewState
    extends State<DriverPrivateSuspendedView> {
  bool isLoading = true;
  List offersList = [];
  Map acceptedOffer = {};
