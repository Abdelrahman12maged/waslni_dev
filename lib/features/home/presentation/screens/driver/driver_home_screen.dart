...
// ─── Palette ─────────────────────────────────────────────────────────────────
const _kNavy    = AppColors.primary;       // #1A237E
const _kNavyMid = AppColors.primaryLight;  // #3949AB
const _kGold    = AppColors.accent;        // #FBD784
const _kGreen   = AppColors.success;       // #4CAF50
...
class _DriverHomeScreenState extends State<DriverHomeScreen>
  ...
  // ── Radius modal (syncs with DriverTripsCubit) ──────────────────────────────
        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              child: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                Text('${r.toInt()}',
                    style: const TextStyle(
                        fontSize: 26, fontWeight: FontWeight.bold, color: _kNavy)),
                Text(S.of(context).kmOnly, style: const TextStyle(fontSize: 12, color: _kSub)),
              ])),
            ),
            ...
            SliderTheme(
              ...
              child: Slider(
                value: r, min: 5, max: 200, divisions: 39,
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  di.sl<LocalStorage>().saveString(
                      key: 'driver_search_radius', value: r.toInt().toString());
                  DriverHomeCubit.of(context).loadHomeData(silent: true, radius: r);
                  setState(() {});
                },
          ...
          return Scaffold(
            ...
            body: Center(child: Padding(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                const SizedBox(height: 18),
                ElevatedButton.icon(
                  onPressed: () => DriverHomeCubit.of(context).loadHomeData(),
        ...
        return BlocBuilder<DriverTripsCubit, DriverTripsState>(
          builder: (context, tripsState) {
            ...
            if (tripsState is DriverTripsLoaded) {
              final activeTrip = TripSecurityService.getActiveTrip(_storage);
              if (activeTrip != null) {
                HomeWidgetService.updateActiveTrip(trip: activeTrip, isDriver: true);
              } else {
      ...
      child: Container(
        ...
        child: SafeArea(
          ...
          child: Padding(
            ...
            child: Row(children: [
              // Refresh button — circular white floating button
              GestureDetector(
              ...
              AnimatedBuilder(
                ...
                builder: (_, __) => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: _kGold.withOpacity(0.6 + 0.4 * _glowAnim.value),
                        width: 2),
                    boxShadow: [
                      BoxShadow(
                          color: _kGold.withOpacity(0.35 * _glowAnim.value),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              const Icon(Icons.settings_rounded, color: Colors.white, size: 12),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: _kGreen.withOpacity(0.08),
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(S.of(context).hasActiveTripNotice,
                style: const TextStyle(
                    color: Color(0xFF1B5E20), fontWeight: FontWeight.bold, fontSize: 12)),
            Text(S.of(context).continueActiveTrip,
                style: const TextStyle(color: Color(0xFF388E3C), fontSize: 10.5)),
          ])),
          const Icon(Icons.arrow_forward_ios_rounded, color: _kGreen, size: 12),
        ]),
      ),
    );
  }
  ...
  Widget _buildTripsHeroCard(int openCount) {
    return GestureDetector(
      onTap: () => navigateTo(context, const DriverNewTripsAcceptScreenClean()),
      child: Container(
    ...
    return Stack(children: [
      ...
      Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          // Top Row: Gold Pill Badge (Right) & Radar Icon (Left)
          Row(children: [
            // Gold pill badge
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text(
                  count > 0 ? S.of(context).newRequestsCount(count) : S.of(context).newTripsStat,
                  style: const TextStyle(
                    color: _kNavy,
                    fontWeight: FontWeight.bold,
                    fontSize: 11.5,
            ...
            // Animated gold radar concentric circles target icon
            AnimatedBuilder(
              animation: _glowAnim,
              builder: (_, __) => Container(
                width: 36,
                ...
                decoration: BoxDecoration(
                  ...
                  color: Colors.white.withOpacity(0.08),
                  border: Border.all(
                    color: _kGold.withOpacity(0.4 + 0.3 * _glowAnim.value),
                    width: 1.2,
                  ),
                ),
                child: Center(
                  child: Container(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: _kGold.withOpacity(0.85 + 0.15 * _glowAnim.value),
                        ),
                      ),
                    ),
                  ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.arrow_back_rounded, color: _kNavy, size: 16),
  ...
  Widget _buildStatsGrid(DriverHomeLoaded data, [int? openCount]) {
    // In RTL:
    // Index 0: Top-Right (New Trips - Orange)
    // Index 1: Top-Left (Current Trips - Green)
    // Index 2: Bottom-Right (Completed Trips - Navy)
    // Index 3: Bottom-Left (Suspended Trips - Purple)
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  height: 6,
                  decoration: BoxDecoration(
                    color: item.count > 0 ? item.color : Colors.transparent,
                    shape: BoxShape.circle,
                  ),
                ),
              ],
            ...
            // Large bold count in the Center
            Center(
              child: Text(
                '${item.count}',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 26,
                  fontWeight: FontWeight.bold,
                  color: item.count > 0 ? item.color : Colors.grey.shade400,
                  height: 1.0,
                ),
              ),
            ),
  ...
  // ── Pending Shared Trip Pricing Recovery ──────────────────────────────────
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  S.of(modalContext).pendingPricingTripTitle,
                                  style: const TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                ...
                                const SizedBox(height: 2),
                                Text(
                                  S.of(modalContext).pendingPricingTripSubtitle,
                                  style: TextStyle(
                                    fontSize: 12,
                          ...
                          Expanded(
                            child: SliderTheme(
                              data: SliderTheme.of(modalContext).copyWith(
                                activeTrackColor: _kNavy,
                                inactiveTrackColor: _kNavy.withOpacity(0.15),
                                thumbColor: _kNavy,
                                trackHeight: 5,
                              ),
                              child: Slider(
                                value: selectedPrice.clamp(parsedMin, parsedMax),
                                min: parsedMin,
                                max: parsedMax,
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                              ...
                              onChanged: (val) {
                                ...
                                if (entered != null) {
                                  setModalState(() => selectedPrice = entered);
                                }
                              },
                            ),
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: isSubmitting
                              ...
                              : () async {
                                  ...
                                  try {
                                    ...
                                    final offerRes =
                                        await di.sl<MakeOfferUseCase>().call(
                                      offerData: {
                                        "driver_id": driverId,
                                        "trip_id": trip.id,
                                        "note": '',
                                    ...
                                    await offerRes.fold(
                                      ...
                                      (_) async {
                                        ...
                                        _storage.saveString(
                                            key: 'offer_status_${trip.id}',
                                            value: 'accepted');
                                        await _storage.remove(
                                            key: 'pending_pricing_trip_id');
                                        if (mounted) {
                                          Navigator.pop(modalCtx);
                                          showToast(
                                              text: S.of(context).tripPriceConfirmedSuccess,
                          ...
                          child: isSubmitting
                              ...
                              : Text(
                                  S.of(modalContext).confirmPriceAndActivateTrip,
                                  style: const TextStyle(
                              ...
                              : () async {
                                  final confirm = await showDialog<bool>(
                                    ...
                                    builder: (dCtx) => AlertDialog(
                                      title: Text(S.of(modalContext).confirmCancelTrip),
                                      content: Text(
                                          S.of(modalContext).cancelPendingTripConfirm),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(dCtx, false),
                                          child: Text(S.of(modalContext).backOrDismiss),
                                        ),
                                        ElevatedButton(
                                          onPressed: () =>
                                          ...
                                          child: Text(S.of(modalContext).yesCancel,
                                              style: const TextStyle(
                                                  color: Colors.white)),
                                        ),
                                      ],
                                  ...
                                  if (confirm == true) {
                                    try {
                                      await di.sl<ChangeTripStatusUseCase>().call(
                                            tripId: trip.id,
                                            status: 'canceled',
                                          );
                                      await _storage.remove(
...
// ── Wave Clipper ──────────────────────────────────────────────────────────────
/// Creates a smooth concave downward curve at the bottom of the header.
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: AppColors.warning.withOpacity(0.06),
                blurRadius: 8, offset: const Offset(0, 2))
          ],
        ),
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(S.of(context).kycRequiredMessage,
                style: TextStyle(color: Colors.orange.shade700, fontSize: 10.5),
