class UserAddSharedTripModel {
  String? message;
  CreatedTripResponse? trip;

  UserAddSharedTripModel({this.message, this.trip});

  UserAddSharedTripModel.fromJson(Map<String, dynamic> json) {
...
/// Response shape for a newly created shared trip.
