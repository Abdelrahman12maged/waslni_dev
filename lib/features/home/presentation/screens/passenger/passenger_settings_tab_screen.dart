...
class PassengerSettingsTabScreen extends StatefulWidget {
  const PassengerSettingsTabScreen({super.key});

  @override
  State<PassengerSettingsTabScreen> createState() =>
      _PassengerSettingsTabScreenState();
}

class _PassengerSettingsTabScreenState
    extends State<PassengerSettingsTabScreen> {
  bool isEnglish = true;
