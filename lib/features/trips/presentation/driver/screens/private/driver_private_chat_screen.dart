...
class DriverPrivateChatScreenClean extends StatefulWidget {
  const DriverPrivateChatScreenClean({
    super.key,
    this.m_id,
    this.chat_id,
    this.r_name,
  ...
  @override
  State<DriverPrivateChatScreenClean> createState() =>
      _DriverPrivateChatScreenCleanState();
}

class _DriverPrivateChatScreenCleanState extends State<DriverPrivateChatScreenClean> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: disabled
                  ? defaultText(text: "Can't Write To Chat Anymore")
                  : Container(
  ...
  void _sendMessage() async {
    ...
    if (text.isNotEmpty) {
      try {
        ...
        log('Error sending message: $e', name: 'DriverPrivateChat');
        showDialog(
          context: context,
