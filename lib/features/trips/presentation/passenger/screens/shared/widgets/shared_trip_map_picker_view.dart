...
class SharedTripMapPickerView extends StatefulWidget {
  ...
  @override
  State<SharedTripMapPickerView> createState() =>
      _SharedTripMapPickerViewState();
}

class _SharedTripMapPickerViewState extends State<SharedTripMapPickerView>
  ...
  LatLng _currentCameraTarget =
      const LatLng(31.9539, 35.9106); // Amman default
  ...
  Future<void> _initPosition() async {
    if (_currentStep == MapPickerStep.destination && _destLatLng != null) {
  ...
  void _returnResult() {
    Navigator.of(context).pop({
      ...
      'originName':
          _originName.isNotEmpty ? _originName : S.of(context).pickupLocation,
      'destLat': _destLatLng?.latitude,
      'destLng': _destLatLng?.longitude,
      'destName':
          _destName.isNotEmpty ? _destName : S.of(context).destination,
    });
  }
      ...
      markers.add(
        Marker(
          ...
          infoWindow: InfoWindow(
              title: '${S.of(context).pickupLocation}: $_originName'),
        ),
      );
    }
    if (_destLatLng != null && !isDestStep) {
      markers.add(
        Marker(
          ...
          infoWindow:
              InfoWindow(title: '${S.of(context).destination}: $_destName'),
        ),
      );
    }
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            bottom: 0,
            child:
                _buildBottomPanel(isOriginStep, isDestStep, isReviewStep),
          ),
        ],
      ),
    );
  ...
  Widget _buildTabButton({
    ...
    return InkWell(
      onTap: () {
        ...
        } else if (step == MapPickerStep.destination &&
            _destLatLng != null) {
          _animateToLocation(_destLatLng!);
          _resolveAddressForTarget(_destLatLng!);
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            title:
                Text(s.description, style: GoogleFonts.cairo(fontSize: 12)),
  ...
  Widget _buildBottomPanel(bool isOrigin, bool isDest, bool isReview) {
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.cairo(
                    ...
                    fontSize: 13,
                    color:
                        isOrigin ? Colors.green.shade800 : Colors.red.shade800,
                  ),
                ),
                const Spacer(),
