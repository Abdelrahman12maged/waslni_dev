...
class DriverPrivateSuspendedScreenClean extends StatefulWidget {
  ...
  @override
  State<DriverPrivateSuspendedScreenClean> createState() =>
      _DriverPrivateSuspendedScreenCleanState();
}

class _DriverPrivateSuspendedScreenCleanState
    extends State<DriverPrivateSuspendedScreenClean> {
  bool isLoading = true;
  List offersList = [];
  Map acceptedOffer = {};
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final Offer offer = rawOffer is Offer
                          ? rawOffer
                          : OfferModel.fromJson(Map<String, dynamic>.from(rawOffer is Map ? rawOffer : {}));
                      ...
                      final price = offer.price > 0
                          ...
                          : (widget.trip.approvedPrice?.toStringAsFixed(2) ?? widget.trip.maximumPrice.toStringAsFixed(2));
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text(
                                  offer.creator?.name.isNotEmpty == true ? offer.creator!.name : S.of(context).passenger,
                                ...
                                children: [
                                  Expanded(
                                    child: ElevatedButton(
                                      onPressed: () {
                                        DriverTripsCubit.get(context).changeOfferStatus(
                                          id: offer.id,
                                          status: 'accepted',
                                          PassState: _passState,
                                          stoploading: () {
                                      ...
                                      child: Text(S.of(context).acceptOffer, style: GoogleFonts.cairo(color: Colors.white)),
                                    ),
                                  ),
                                  ...
                                  Expanded(
                                    child: ElevatedButton(
                                      ...
                                      child: Text(S.of(context).rejectOffer, style: GoogleFonts.cairo(color: Colors.white)),
                                    ),
                                  ),
                                ],
                              ),
