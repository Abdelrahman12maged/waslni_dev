...
import 'package:car_app/features/trips/presentation/passenger/widgets/add_trip/passenger_matching_trips_sheet.dart';
import 'package:car_app/features/trips/presentation/passenger/widgets/add_trip/passenger_shared_trip_details_sheet.dart';
...
class PassengerAddSharedTripView extends StatefulWidget {
  const PassengerAddSharedTripView({super.key});
  ...
  @override
  State<PassengerAddSharedTripView> createState() =>
      _PassengerAddSharedTripViewState();
}

class _PassengerAddSharedTripViewState extends State<PassengerAddSharedTripView>
  ...
  void _onSearchQueryChanged(
      String query, PassengerAddSharedTripCubit cubit) {
    _debounceTimer?.cancel();
  ...
  void _showTripDetailsSheet(
      BuildContext context, PassengerAddSharedTripCubit cubit) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => SharedTripDetailsSheet(
        cubit: cubit,
        onEditStart: () {
    ...
    return BlocConsumer<PassengerAddSharedTripCubit,
      ...
      listener: (ctx, state) {
        ...
        if (state is PassengerAddSharedTripMatchingTripFoundState) {
          ...
          showMatchingTripFoundSheet(
            ctx,
            cubit: cubit,
            trip: state.matchingTrip,
            allMatches: state.allMatchingTrips,
          );
        }
            ...
            children: [
              GoogleMap(
                ...
                initialCameraPosition:
                    PassengerAddSharedTripView._kGooglePlex,
                onMapCreated: (c) {
                  _mapController = c;
