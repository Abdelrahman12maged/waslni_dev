...
class DriverSettingsTabView extends StatefulWidget {
  const DriverSettingsTabView({super.key});

  @override
  State<DriverSettingsTabView> createState() => _DriverSettingsTabViewState();
}

class _DriverSettingsTabViewState extends State<DriverSettingsTabView> {
  bool isEnglish = true;
          ...
          settingsTile(
            ...
            onTap: () {
              final driverId = int.tryParse(
                  ...
                  0;
              context.push(AppRoutes.driverRatings,
