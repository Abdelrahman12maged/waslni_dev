...
class _DriverEditProfileScreenState extends State<DriverEditProfileScreen> {
    ...
    if (userCached != null && userCached is Map) {
      ...
      setState(() {
        ...
        if (car != null) {
          ...
          // Pre-populate plate number in formatted NN - NNNNN form
  ...
  Future<void> _updateProfile(ProfileCubit cubit) async {
    ...
    if (!driverLicenseImage1.contains('http') && driverLicenseImage != null) {
    ...
    if (!driverCarOutsideImage1.contains('http') && driverCarOutsideImage != null) {
    ...
    if (!driverCarInsideImage1.contains('http') && driverCarInsideImage != null) {
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: Padding(
            ...
            child: Column(
              children: [
                // Header avatar picker with orbit SVG background
                SizedBox(
                  height: 160,
                  child: Stack(
                    alignment: Alignment.center,
                                ...
                                children: [
                                  ...
                                  largeImagePicker(
                                    ...
                                    onTap: () => showImagePickerOptions(
                                      ...
                                      onSourceSelected: (source) =>
                                          getDriverInfoImages(0, source: source),
                                    ),
                                  ...
                                  largeImagePicker(
                                    ...
                                    onTap: () => showImagePickerOptions(
                                      context,
                                      onSourceSelected: (source) =>
                                          getDriverInfoImages(1, source: source),
                                    ),
                                  ...
                                  largeImagePicker(
                                    ...
                                    onTap: () => showImagePickerOptions(
                                      context,
                                      onSourceSelected: (source) =>
                                          getDriverInfoImages(2, source: source),
                                    ),
