...
class PassengerEditProfileView extends StatefulWidget {
  final VoidCallback updateStates;

  const PassengerEditProfileView({super.key, required this.updateStates});

  @override
  State<PassengerEditProfileView> createState() =>
      _PassengerEditProfileViewState();
}

class _PassengerEditProfileViewState extends State<PassengerEditProfileView> {
