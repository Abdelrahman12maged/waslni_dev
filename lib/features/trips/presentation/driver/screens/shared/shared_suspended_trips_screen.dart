...
class SharedSuspendedTripsScreenClean extends StatefulWidget {
  ...
  @override
  State<SharedSuspendedTripsScreenClean> createState() =>
      _SharedSuspendedTripsScreenCleanState();
}

class _SharedSuspendedTripsScreenCleanState
    extends State<SharedSuspendedTripsScreenClean> {
  bool isLoading = true;
  List offersList = [];
  Map acceptedOffer = {};
