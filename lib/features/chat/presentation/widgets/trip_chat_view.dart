...
class TripChatView extends StatefulWidget {
  ...
  @override
  State<TripChatView> createState() => _TripChatViewState();
}

class _TripChatViewState extends State<TripChatView> {
  ...
  Future<void> _notifyChatRecipients(
    ...
    try {
      ...
      if (targetRecipients.isEmpty) {
        log('[TripChat FCM Debug] âš ï¸ No target FCM tokens found for trip #$tripIdInt! Notification will not be sent.',
            name: 'TripChat');
        return;
      }

      log('[TripChat FCM Debug] ðŸš€ Dispatching FCM notifications to ${targetRecipients.length} recipients: $targetRecipients',
          name: 'TripChat');
      ...
      log('[TripChat FCM Debug] âŒ Error in _notifyChatRecipients: $e\n$stack',
          name: 'TripChat');
    }
  }
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // â”€â”€ 1. Private Trip Options â”€â”€
              if (!_isSharedTrip) ...[
                if (!_isDriver) ...[
                    ...
                    onTap: () {
                      ...
                      _confirmAction(
                        ...
                        onConfirmed: () async {
                          ...
                          final ok = await context.read<PassengerTripsCubit>()
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            // â”€â”€ Top Mini Trip Info Card â”€â”€
            Container(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${widget.tripFrom.isNotEmpty ? widget.tripFrom : S.of(context).chatFrom} â¬…ï¸ ${widget.tripTo.isNotEmpty ? widget.tripTo : S.of(context).chatTo}',
                          style: GoogleFonts.cairo(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
            ...
            // â”€â”€ Quick Driver Presets Bar (Driver Only) â”€â”€
            if (_isDriver)
              Container(
                height: 38,
            ...
            // â”€â”€ Bottom Message Input Bar â”€â”€
            SafeArea(
              top: false,
              child: Container(
                padding:
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              // â”€â”€ Sender Name & Driver Badge Header â”€â”€
              Padding(
