...
class PassengerSharedTripDetailsView extends StatefulWidget {
  final Trip? trip;
  final int? tripId;

  const PassengerSharedTripDetailsView({
    super.key,
    this.trip,
    this.tripId,
  });
  ...
  @override
  State<PassengerSharedTripDetailsView> createState() =>
      _PassengerSharedTripDetailsViewState();
}

class _PassengerSharedTripDetailsViewState
    extends State<PassengerSharedTripDetailsView> {
  int currentIndex = 0;
