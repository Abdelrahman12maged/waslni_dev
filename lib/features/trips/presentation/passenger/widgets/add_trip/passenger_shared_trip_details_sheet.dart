...
/// Bottom sheet dialog for configuring shared trip details (Date/Time, Gender, Seats count).
class SharedTripDetailsSheet extends StatefulWidget {
  final PassengerAddSharedTripCubit cubit;
  final VoidCallback onEditStart;
  final VoidCallback onEditDestination;

  const SharedTripDetailsSheet({
    super.key,
    required this.cubit,
  ...
  @override
  State<SharedTripDetailsSheet> createState() => _SharedTripDetailsSheetState();
}

class _SharedTripDetailsSheetState extends State<SharedTripDetailsSheet> {
                      ...
                      ConditionalBuilder(
                        ...
                        builder: (_) => SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: (state
                                        is PassengerAddSharedTripLoadingState ||
                                    _isSubmitting)
                                ? null
                                : () {
