...
class DriverRatingsView extends StatelessWidget {
  final int driverId;
        ...
        builder: (context, state) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => RatingsCubit.get(context)
                          .getDriverRatings(driverId: driverId),
          ...
          if (state is DriverRatingsLoaded) {
            ...
            return RefreshIndicator(
              onRefresh: () async => RatingsCubit.get(context)
                  .getDriverRatings(driverId: driverId),
              ...
              children: [
                ...
                Row(
                  ...
                  children: List.generate(5, (idx) {
                    return Icon(
                      idx < summary.average.round()
                          ? Icons.star_rounded
                          : Icons.star_outline_rounded,
                      size: 18,
                      color: idx < summary.average.round()
                          ? Colors.amber
