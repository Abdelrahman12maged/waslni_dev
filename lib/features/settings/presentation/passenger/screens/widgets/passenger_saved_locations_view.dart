...
class PassengerSavedLocationsView extends StatelessWidget {
  const PassengerSavedLocationsView({super.key});
                    ...
                    : ListView(
                        ...
                        children: [
                          ...
                          ...locations.map((loc) => _SavedLocationCard(
                                ...
                                onDelete: () =>
                                    _confirmDelete(context, cubit, loc),
                              )),
                        ],
                      ),
              ),
