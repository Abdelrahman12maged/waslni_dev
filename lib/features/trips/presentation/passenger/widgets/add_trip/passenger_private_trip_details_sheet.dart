...
/// Bottom sheet dialog for configuring private trip details (Date/Time, Gender preference).
class PrivateTripDetailsSheet extends StatefulWidget {
  final PassengerAddPrivateTripCubit cubit;
  final VoidCallback onEditStart;
  final VoidCallback onEditDestination;

  const PrivateTripDetailsSheet({
    super.key,
    required this.cubit,
  ...
  @override
  State<PrivateTripDetailsSheet> createState() =>
      _PrivateTripDetailsSheetState();
}

class _PrivateTripDetailsSheetState extends State<PrivateTripDetailsSheet> {
