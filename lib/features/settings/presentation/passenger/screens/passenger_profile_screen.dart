...
class PassengerProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ProfileCubit>(
      ...
      child: const _PassengerProfileContent(),
    );
  }
}

class _PassengerProfileContent extends StatefulWidget {
  const _PassengerProfileContent();

  @override
  State<_PassengerProfileContent> createState() => _PassengerProfileContentState();
}

class _PassengerProfileContentState extends State<_PassengerProfileContent> {
                  ...
                  children: [
                    ...
                    defaultButton(
                      onPressed: () {
                        navigateTo(
                          context,
                          PassengerEditProfileScreen(updateStates: _getUserCachedData),
                        );
                      },
