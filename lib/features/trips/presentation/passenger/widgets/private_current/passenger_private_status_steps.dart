...
/// Horizontal 5-step progression timeline indicator for passenger tracking screen.
class PassengerPrivateStatusSteps extends StatelessWidget {
  const PassengerPrivateStatusSteps({
    super.key,
    required this.phase,
